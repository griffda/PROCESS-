...
class PlasmaGeom:
    ...
    def geomty(self):
        ...
        if physics_variables.igeom == 0:  # Use original methods

            physics_variables.pperim = self.perim(
            ...
            physics_variables.vol = physics_variables.cvol * self.fvol(
            ...
            physics_variables.sareao = so
            physics_variables.sarea = sa

            physics_variables.xarea = self.xsect0(
                physics_variables.rminor,
                physics_variables.kappa,
                physics_variables.triang,
            )
