...
class Vmcon:
    ...
    def run(self):
        ...
        (
            ...
            self.delta,
            self.wa,
            self.cnorm[: self.lcnorm, : self.m],
            self.h,
            numerics.vlam[: self.m + (2 * self.n) + 1],
            self.vmu[: self.m + (2 * self.n) + 1],
            self.gm[: self.n + 1],
            self.bdl[: self.n + 1],
            self.bdu[: self.n + 1],
    ...
    def fcnvmc1_wrapper(self):
        ...
        try:
            ...
            # TODO Investigate
            logger.warning(
                f"conf array size mismatch: attempted to broadcast "
    ...
    def fcnvmc2_wrapper(self):
        ...
        try:
            ...
            # TODO Investigate
            logger.warning(
                f"fgrd array size mismatch: attempted to broadcast "
