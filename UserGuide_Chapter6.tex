...
%Psep/ Pdiv = power crossing the separatrix, M = average ion mass, Thermal power _= high grade heat for electricity production, gross cycle efficiency _(,)/_, Net cycle efficiency (_(,)−_(,))/(_−_(,) ), Net electric power_(,)=_(,)−_, Plant efficiency _(,)/_ 
\end{description}
