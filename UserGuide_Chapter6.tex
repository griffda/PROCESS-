...
plot\_XX\_info functions (where XX is {\bf physics}, {\bf magnetics}, etc.).
...
\item \texttt{ndscan\_package_only.py} - creates a NetCDF output file from a previous Nd-scan run.
