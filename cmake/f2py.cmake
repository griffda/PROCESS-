...
MACRO(F2PY)
    ...
    IF(NOT CMAKE_HOST_APPLE)
        ADD_CUSTOM_COMMAND(
            ...
            COMMAND echo \"Running f2py:\"\; LDFLAGS=-Wl,-rpath=\\$$ORIGIN/lib ${F2PY_NAME} -c -L../process/lib/ -l${PROJECT_NAME} ${PROCESS_WRAP_SRC_PATHS} --build-dir ${CMAKE_BINARY_DIR} # -DINSTALLDIR="${CMAKE_SOURCE_DIR}" -DCOMMSG="${COMMIT_MSG}" -Dtagno="${GIT_TAG}" -Dbranch_name="${GIT_BRANCH}" -Duntracked="${GIT_DIFF}"
