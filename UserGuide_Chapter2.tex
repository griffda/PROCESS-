...
input (see Figures~\ref{fig:flow_hybrd} and \ref{fig:flow_vmcon}). Tables~\ref{tab:itvars1} and~\ref{tab:itvars2} list the iteration variables available in \process.  Any one or more of these variables may be selected.
...
99  & \texttt{}         & (OBSOLETE)                                              & 57  & \texttt{0.001D0} & \texttt{1.000D0} \\
100 & \texttt{}         & (OBSOLETE)                                              & 58  & \texttt{0.001D0} & \texttt{1.000D0} \\
...
110 & \texttt{ftaulimit}& f-value for limit on ratio of alpha particle to energy confinement times & 62  & \texttt{0.001D0} & \texttt{1.000D0} \\
