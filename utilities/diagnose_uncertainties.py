...
def plot_distribution(xarr, labelx, unc_dict):
    ...
    if unc_dict['errortype'].lower() == 'gaussian':
        ...
        err = unc_dict['percentage']/100.
        lbound = unc_dict['mean']*(1.-err)
        ubound = unc_dict['mean']*(1.+err)
        xvalues = linspace(lbound, ubound, 10)
        yvalues = [mean(n_arr)]*10
...
#Usage
    ...
    PARSER = argparse.ArgumentParser(description='Program to check\
...
pdf")
    ...
    PARSER.add_argument("-u", "--uncertainties",
