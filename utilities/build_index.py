...
if __name__ == "__main__":
    ...
    PARSER.add_argument(
        "-b", "--base", default="Run", help="Subdiretories basename, default=Run"
    )
    ...
    PARSER.add_argument(
        "-r", "--readme", default="README.txt", help="Name of the file to be indexed"
    )
    ...
    for suf in SUFFIXLIST:
        ...
        try:
            ...
            if ARGS.verbose:
                print(
                    "File %s/%s not found and ignored!" % (ARGS.base + suf, ARGS.readme)
                )
            continue
