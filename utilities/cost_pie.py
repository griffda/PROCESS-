...
def step_cost_model():
    ...
    step21 = m_file.data["step21"].get_scan(-1)             # Building and Site Service Infrastructure
    ...
    cdirt = m_file.data["cdirt"].get_scan(-1)       # Plant Direct Cost
    step91 = m_file.data["step91"].get_scan(-1)     # Construction Facilities, Equipment and Services
    ...
    labels = ['Site and Buildings', 'Blanket and First Wall', 'Shield', 'Magnets',
        'Other Reactor Equipment', 'Heat Transfer System', 'Other Reactor Plant Equipment',
