...
C      call EQGB3(BR00,SA0,GL0,GD30,NA)
     ...
     >			WSCI1,WSCI3,WSCI5,WSCI7,WSCJ1,WSCJ3,WSCJ5,WSCJ7)
      ...
      NAOLD=NA
      WBR00=BR00
!						write(*,*) AOLD,GLOLD,G3DOLD,NAOLD,WBR00
 4    continue
      do  I=1,NA1
         WSJP(I)=BA(I)
         WSP(I)=BB(I)
...
C     >,ITER,WSAC1,WSAC2,WSAC3,WBR0,WGL,WSD1,WSD3,WDGL,WSL0,WSL1,WSL2
C     >,WSL22
     >)
      implicit none
      include	'emeq.inc'
...
CC      double precision
C     1	   WSAC1,WSAC2,WSAC3,WBR0,WBR00,
C     2	   WGL(*),WSD1(*),WSD3(*),WDGL(*),WSL0(*),WSL1(*),WSL2(*),
C     3	   WSL22(*),
      double precision
...
C      include	'emeq.inc'
	...
	double precision	WBR0,WBR00
	double precision	WSA(*),WSAA(*),WGL(*),WSD3(*),WDSD3(*)
	double precision	WSCI1(*),WSCI3(*),WSCI5(*),WSCI7(*)
	double precision	WSCJ1(*),WSCJ3(*),WSCJ5(*),WSCJ7(*)
      WBR00=BR00
      WBR0=BR00
      DA=SA0/NA
      D3=GD30/SA0**2
...
C----------------------------------------------------------------------|
	implicit none
!	include	'emeq.inc'
	double precision	WBR0,WSAA(*),WGL(*),WSD1(*),WSD3(*)
	double precision	WSL0(*),WSL1(*),WSL2(*),WSL3(*),WSL22(*)
	double precision	WSV0(*),WSV1(*),WSV2(*),WSV3(*)
	double precision	WSU0(*),WSU1(*),WSU2(*),WSU3(*)
	integer	NA,NA1,I
	double precision
...
C	double precision WSA(1),WSP(1),WSJP(1),WBA(1),WBB(1),WDBA(1),WDBB(1)
	double precision WBR0,WBR00,WSA(*)
	double precision WBA(*),WBB(*),WSP(*),WSJP(*),WDBA(*),WDBB(*)
...
C	double precision WBA(*),WBB(*),WGL(*),WGP(*),WDBA(*),WDBB(*)
C	double precision WSJ(*),WSJSL(*),WSJSR(*),WDSJ(*)
...
C	double precision WBD0(1),WBD12(1),WBD02(1)
C	double precision WBG22(1),WBG33(1),WBG332(1)
C	double precision WSCI3(1),WSCJ3(1),WSCJ1(1)
C	double precision WSL0(1),WSU0(1),WSW0(1),WSV0(1),WGMC(1),WDGMC(1)
C	double precision WSJSL(1),WSJSR(*)
	integer	NA,NA1,I,J
	double precision
...
C======================================================================|
C EQGB3.FOR - INITIAL CONDITIONS FOR THREE MOMENT EQUILIBRIA 17-AUG-1988
	BLOCK DATA GB3
	implicit none
	include	'emeq.inc'
