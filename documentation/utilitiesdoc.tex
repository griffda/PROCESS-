...
\begin{description}
	...
	\item{\textbf{Output:}}
	Displays plot of the cost breakdown to screen.  For the 1990 cost model, the breakdown for direct, indirect and contingency is also shown.  These can be saved with -s argument (cost\_breakdown.png and direct\_cost\_breakdown.png).
