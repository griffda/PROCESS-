...
The UQ\_error\_summary.txt file is an ascii text file summarising all values of the uncertain parameter inputs and whether their runs have found a feasible solution (ifail=1), have encountered any PROCESS errors (ifail=-1, error\_status=3) or whether they have not found a feasible solution (all other ifail values, for details see PROCESS user guide). This file can be used to analyse parameter spaces prone to errors.
