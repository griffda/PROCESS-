...
\hypertarget{process-variable-descriptor-file-dated-20190715}{%
\subsection{PROCESS Variable Descriptor File : dated
20190715}\label{process-variable-descriptor-file-dated-20190715}}
...
\item
  ...
  density If \textless0, pedestal-top density set manually using neped
  (ipedestal\textgreater=1) Needs to be \textgreater0 if ipedestal = 3
  (iteration variable 145)
\item
  fgwsep /0.50/ : fraction of Greenwald density to set as separatrix
  density If \textless0, separatrix density set manually using nesep
  (ipedestal\textgreater=1) Needs to be \textgreater0 if ipedestal = 3
\item
...
\item
  fplhsep /1.0/ : F-value for Psep \textgreater= Plh + Paux (constraint
  equation 73)
\item
...
\item
  rhopedt /1.0/ : r/a of temperature pedestal (ipedestal\textgreater=1)
\item
...
\item
  ...
  (ipedestal\textgreater=1) calculated if reinke criterion is used (icc
  = 78)
\item
...
\hypertarget{current_drive_variables}{%
...
\hypertarget{divertor_kallenbach_variables}{%
...
\item
  ...
  \item
    \textless\textgreater0, tohs = tohsin; tramp, tqnch are input
  \end{itemize}
\item
...
(81) F-value for ne(0) \textgreater{} ne(ped) constraint (itv 154 fne0)
