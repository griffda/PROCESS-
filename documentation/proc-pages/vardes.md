...
<table class="vardes">
	...
	<tr>
		...
		<td>real</td>
		<td>0.0D0</td>
		<td>Top outer radius of centre of the centropost (ST only) (m)</td>
	</tr>
	<tr>
...
<table class="vardes">
	...
	<tr>
		...
		<td>real</td>
		<td>400.0D0</td>
		<td>ucrb /400.0/ : cost of reactor building (M\$/m3)</td>
	</tr>
	<tr>
		<td>ucsc</td>
		<td>real</td>
		<td>(/600.0D0, 600.0D0, 300.0D0, 6...</td>
		<td>ucsc(6) /600.0,600.0,300.0,600.0/ : cost of superconductor (\$/kg)</td>
	</tr>
	<tr>
		<td>ucsh</td>
		<td>real</td>
...
<table class="vardes">
	...
	<tr>
		...
		<td>real</td>
		<td>1.d-4</td>
		<td>abserr_sol : Absolute contribution to the error tolerance in the Kallenbach divertor model</td>
	</tr>
	<tr>
		<td>exchangepowerlost</td>
		<td>real</td>
		<td>None</td>
		<td>exchangepowerlost : Power lost due to charge exchange  [W]</td>
	</tr>
	<tr>
		<td>fmom</td>
		<td>real</td>
		<td>None</td>
		<td>fmom : momentum factor [-]</td>
	</tr>
	<tr>
		<td>fractionwidesol</td>
		<td>real</td>
		<td>0.1D0</td>
		<td>fractionwidesol /0.1/ : Distance from target at which SOL gets broader as a fraction of connection length</td>
	</tr>
	<tr>
		<td>hydrogenicpowerlost</td>
		<td>real</td>
		<td>None</td>
		<td>hydrogenicpowerlost : Power lost due to hydrogenic radiation [W]</td>
	</tr>
	<tr>
		<td>impurity_enrichment</td>
		<td>real</td>
		<td>['5.0D0', '5.0D0', '5.0D0', '5...</td>
		<td>impurity_enrichment(14) /5.0/ : Ratio of each impurity concentration in SOL to confined plasma+<br>the enrichment for Argon is also propagated for PLASMOD (ipedestal=3)</td>
	</tr>
	<tr>
		<td>impuritypowerlost</td>
		<td>real</td>
		<td>None</td>
		<td>impuritypowerlost : Power lost due to impurity radiation [W]</td>
	</tr>
	<tr>
		<td>ionisationpowerlost</td>
		<td>real</td>
		<td>None</td>
		<td>ionisationpowerlost : Power lost due to electron impact ionisation [W]</td>
	</tr>
	<tr>
		<td>kallenbach_scan_end</td>
		<td>real</td>
		<td>10.0</td>
		<td>kallenbach_scan_end /10.0/ : End value for kallenbach scan parameter</td>
	</tr>
	<tr>
		<td>kallenbach_scan_num</td>
		<td>integer</td>
		<td>1</td>
		<td>kallenbach_scan_num /1/ : Number of scans for kallenbach scan test</td>
	</tr>
	<tr>
		<td>kallenbach_scan_start</td>
		<td>real</td>
		<td>2.0</td>
		<td>kallenbach_scan_start /2.0/ : Start value for kallenbach scan parameter</td>
	</tr>
	<tr>
		<td>kallenbach_scan_switch</td>
		<td>integer</td>
		<td>0</td>
		<td>kallenbach_scan_switch /0/ : Switch to run scan of 1D Kallenbach divertor model (1=on, 0=off)</td>
	</tr>
	<tr>
		<td>kallenbach_scan_var</td>
		<td>integer</td>
		<td>0</td>
		<td>kallenbach_scan_var /0/ : Switch for parameter to scan for kallenbach scan test:<br>                  = 0 ttarget<br>                  = 1 qtargettotal<br>                  = 2 targetangle<br>                  = 3 lambda_q_omp<br>                  = 4 netau_sol</td>
	</tr>
	<tr>
		<td>kallenbach_switch</td>
		<td>integer</td>
		<td>0</td>
		<td>kallenbach_switch /0/ : Switch to turn on the 1D Kallenbach divertor model (1=on, 0=off)</td>
	</tr>
	<tr>
		<td>kallenbach_test_option</td>
		<td>integer</td>
		<td>0</td>
		<td>kallenbach_test_option /0/ : Switch to choose kallenbach test option: <br>             = 0 Test case with user inputs;<br>             = 1 Test case for Kallenbach paper;</td>
	</tr>
	<tr>
		<td>kallenbach_tests</td>
		<td>integer</td>
		<td>0</td>
		<td>kallenbach_tests /0/ : Switch to run tests of 1D Kallenbach divertor model (1=on, 0=off)</td>
	</tr>
	<tr>
		<td>lambda_q_omp</td>
		<td>real</td>
		<td>0.002D0</td>
		<td>lambda_q_omp /0.002/ : SOL power fall-off length at the outer midplane, perpendicular to field [m]</td>
	</tr>
	<tr>
		<td>lcon_factor</td>
		<td>real</td>
		<td>1.0D0</td>
		<td>lcon_factor /1.0/ : Correction factor for connection length from OMP to divertor =<br>                     connection length/(piqrmajor)</td>
	</tr>
	<tr>
		<td>mach0</td>
		<td>real</td>
		<td>0.999</td>
		<td>mach0 : Mach number at target (must be just less than 1)</td>
	</tr>
	<tr>
		<td>neomp</td>
		<td>real</td>
		<td>0.0D0</td>
		<td>neomp : Mean SOL density at OMP calculated by the Kallenbach divertor model [m-3]</td>
	</tr>
	<tr>
		<td>neratio</td>
		<td>real</td>
		<td>0.75D0</td>
		<td>neratio /0.75/ : Ratio of mean SOL density at OMP to separatrix density at OMP (iteration variable 121)</td>
	</tr>
	<tr>
		<td>netau_sol</td>
		<td>real</td>
		<td>0.5D0</td>
		<td>netau_sol /0.5/ : Parameter describing the departure from local ionisation equilibrium in the SOL. [ms.1e20/m3]</td>
	</tr>
	<tr>
		<td>pressure0</td>
		<td>real</td>
		<td>0.0D0</td>
		<td>pressure0 : Total plasma pressure near target (thermal+dynamic) [Pa]</td>
	</tr>
	<tr>
		<td>psep_kallenbach</td>
		<td>real</td>
		<td>0.0D0</td>
		<td>psep_kallenbach : Power conducted through the separatrix, as calculated by the divertor model [W]<br>                   Not equal to pdivt unless constraint is imposed.</td>
	</tr>
	<tr>
		<td>qtargettotal</td>
		<td>real</td>
		<td>5.0D6</td>
		<td>qtargettotal /5.0e6/ : Power density on target including surface recombination [W/m2]<br>(iteration variable 124)</td>
	</tr>
	<tr>
		<td>relerr_sol</td>
		<td>real</td>
		<td>1.d-4</td>
		<td>relerr_sol : Relative contribution to the error tolerance in the Kallenbach divertor model</td>
	</tr>
	<tr>
		<td>target_spread</td>
		<td>real</td>
		<td>0.003D0</td>
		<td>target_spread /0.003/ : Increase in SOL power fall-off length due to spreading, mapped to OMP [m]</td>
	</tr>
	<tr>
		<td>targetangle</td>
		<td>real</td>
		<td>30.0D0</td>
		<td>targetangle /30.0/ : Angle between field-line and divertor target (degrees)</td>
	</tr>
	<tr>
		<td>teomp</td>
		<td>real</td>
		<td>0.0D0</td>
		<td>teomp : separatrix temperature calculated by the Kallenbach divertor model [eV]</td>
	</tr>
	<tr>
		<td>totalpowerlost</td>
		<td>real</td>
		<td>None</td>
		<td>totalpowerlost : Total power lost due to radiation, ionisation and recombination [W]</td>
	</tr>
	<tr>
		<td>ttarget</td>
		<td>real</td>
		<td>5.0D0</td>
		<td>ttarget /5.0/ : Plasma temperature adjacent to divertor sheath [eV] (iteration variable 120)<br>                 Rem : 5 eV is the current limit for tungsten sputtering from argon impurity</td>
	</tr>
</table>
...
<table class="vardes">
	...
	<tr>
		<td>impdir</td>
		<td>character</td>
		<td>PYPROCESSPATH//'/data/impuritydat...</td>
...
<table class="vardes">
	...
	<tr>
		...
		<td>real</td>
		<td>None</td>
		<td>Radial position of inner edge of TF coil inboard leg [m]</td>
	</tr>
	<tr>
		<td>r_tf_inboard_out</td>
		<td>real</td>
		<td>None</td>
		<td>Radial position of plasma-facing edge of TF coil inboard leg [m]</td>
	</tr>
	<tr>
...
<table class="vardes">
	...
	<tr>
		...
		<td>real</td>
		<td>14.86D0</td>
		<td>b_crit_upper_nbti /14.86/ : upper critical field of GL_nbti</td>
	</tr>
	<tr>
		<td>bcritsc</td>
		<td>real</td>
	...
	<tr>
		...
		<td>real</td>
		<td>0.5D0</td>
		<td>Fraction of the total vertical force taken by the TF inboard leg<br> Not used for resistive itart=1 (sliding joints)</td>
	</tr>
	<tr>
		<td>farc4tf</td>
		<td>real</td>
		<td>0.7D0</td>
		<td>farc4tf /0.7/ : factor to size height of point 4 on TF coil</td>
	</tr>
	<tr>
		<td>fcoolcp</td>
		<td>real</td>
	...
	<tr>
		...
		<td>real</td>
		<td>0.69D0</td>
		<td>fcutfsu /0.69/ : copper fraction of cable conductor (TF coils)<br>                  (iteration variable 59)</td>
	</tr>
	<tr>
		<td>fhts</td>
		<td>real</td>
	...
	<tr>
		...
		<td>real</td>
		<td>0.0D0</td>
		<td>max_force_density :  Maximal (WP averaged) force density in TF coils at 1 point. (MN/m3)</td>
	</tr>
	<tr>
		<td>n_layer</td>
		<td>integer</td>
	...
	<tr>
		...
		<td>real</td>
		<td>9.04D0</td>
		<td>t_crit_nbti /9.04/ : critical temperature of GL_nbti</td>
	</tr>
	<tr>
		<td>t_turn</td>
		<td>real</td>
	...
	<tr>
		...
		<td>real</td>
		<td>0.0D0</td>
		<td>vertical separating force on inboard leg/coil (N)</td>
	</tr>
	<tr>
		<td>vforce_outboard</td>
		<td>real</td>
		<td>0.0D0</td>
		<td>Vertical separating force on out board leg/coil (N)</td>
	</tr>
	<tr>
		<td>vftf</td>
		<td>real</td>
