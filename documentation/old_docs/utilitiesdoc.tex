...
The output can be defined in any visual data format supported by pyplot, the label font size can set. Please note that to select individual constraints or variable pair plots, it is enough to precise the \texttt{-ic} and the \texttt{-ixv/-iyv} pair, respectively.  \\

If any modification of improvements are foreseen, please let us know.
