\documentclass[hidelinks]{article}
    ...
    \begin{figure}[!b]
     \begin{center}
      \begin{tikzpicture}[scale=1.4]rc (-30:30:50mm);
        ...
        \draw (7.15,3.6) node {rcoil};
        \filldraw[fill=black] (4.6,3.4) circle (0.05cm);
        \draw (4.95,3.6) node {rcoilp};  
    ...
    \text{thtcoil} = \frac{\pi}{\text{n_tf}} 
    \end{equation}

    \noi where \emph{n_tf} is the number of TF coils (seen in figure \ref{fig: geom-1}). 
    ...
    \begin{equation}
        \text{tfc\_current} = \frac{\text{ritfc}}{\text{n_tf}}
    \end{equation}
    ...
    \text{acasetf} = \frac{\text{tfareain}}{\text{n_tf}} - \text{awpc}
    \end{equation}
    ...
    \begin{equation}
    j_{wptf} = \text{max}(1.0, \frac{\text{ritfc}}{\text{n_tf} \times \text{awptf}})
    \end{equation}
    ...
    \text{cforce} = \frac{\text{bmaxtf} \times \text{ritfc}}{2 \times \text{n_tf}}
    \end{equation}
