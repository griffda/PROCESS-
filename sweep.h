...
C
C  Module         : $Id: sweep.h,v 3.2 1994/03/31 09:40:57 peter Exp $
C
C  Module name    : $RCSfile: sweep.h,v $
C  Version no.    : $Revision: 3.2 $
C
C  Creation date  : $Date: 1994/03/31 09:40:57 $
C  Creation time  : 
C
...
CSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCSCCS
      ...
      double precision sweep(ipnscns)
      common /sweep1/  sweep

      integer         isweep, nsweep
      common /sweep2/ isweep, nsweep
