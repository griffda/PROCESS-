...
your Python path. This can be done by adding the following line to your
\texttt{.bashrc} file:
\begin{quote}
\texttt{export PYTHONPATH=\$PYTHONPATH:\url{~pknight/process/bin/utilities}}
\end{quote}
...
definitions of these variables are commented out. This tool does not yet use
the dedicated \process\ Python libraries.
...
python plot_proc.py -g 11 13 18 
# creates demo1.png with Te, n
python plot_proc.py -o demo1.png 21 22
\end{verbatim}
\end{quote}
