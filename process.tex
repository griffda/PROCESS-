...
31  & \texttt{gapomin}  & minimum gap between outboard shield and vacuum vessel &     & \texttt{0.001D0} & \texttt{10.00D0} \\
...
61  & \texttt{gapds}    & gap between vacuum vessel and inboard shield            &     & \texttt{0.000D0} & \texttt{10.00D0} \\
...
\caption[build] {\label{fig:build_d} \textit{Schematic diagram of the fusion
    ...
    Figure~\ref{fig:build_e} (N.B.\ the vacuum vessel shape is drawn
    inaccurately in these figures). Also shown are the code variables used to
...
\item The inboard build of a tight aspect ratio tokamak (TART) is very
  ...
  gap, OH coil, cryostat, and then continuing as in Figure~\ref{fig:build_d}
