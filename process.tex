...
\caption[TABLE_VARS2] {\label{tab:itvars2}
  \textit{Iteration variables 51 to 98 present in \process. The f-values correspond to the
    given constraint equations (see Table~\ref{tab:eqns}). The other iteration
...
for optimisation runs, as using the HYBRID step before a VMCON iteration tends
