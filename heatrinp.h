...
C
C  Module         : $Id: heatrinp.h,v 3.3 1997/01/24 14:54:55 peter Exp $
C
C  Module name    : $RCSfile: heatrinp.h,v $
C  Version no.    : $Revision: 3.3 $
C
C  Creation date  : $Date: 1997/01/24 14:54:55 $
C  Creation time  : 
C
...
C+**PJK 22/01/97 Moved contents of this file to htpwr.h
