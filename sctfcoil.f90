...
subroutine outtf(outfile, peaktfflag)
    ...
    !call ovarre(outfile,'Inboard leg inboard toroidal thickness (m)','(tfocrn)',tfocrn, 'OP ')
...
5   format(t43,'Thickness (m)',t60,'Outer radius (m)')
    ...
    call ovarre(outfile,'Tresca conduit stress criterion', '(i_tf_tresca)', i_tf_tresca, 'OP ')
    ...
    call ovarre(outfile,'CEA Adjusted Tresca stress in conduit (Pa)', '(s_tresca_cea_cond)', s_tresca_cea_cond, 'OP ')
