...
\caption[Power balance within the core plasma] {\label{fig:powerflow1}
  ...
  Figure~\ref{fig:powerflow2} for the onward flow of power from the four
...
\Red{ipowerflow (See also Section~\ref{sec:powerflow}), blbop, thermal\_cycle, blkttype}
...
{\label{fig:current_vs_time}
  \textit{\Red{Redo...} Plot showing schematically the current waveforms for the plasma, a
