module cost_variables
  ...
  subroutine init_cost_variables
    ...
    site_imp_uc = &
      (/ 10.0D0, 30.0D0, 60.0D0, 50.0D0, 20.0D6, 30.0D6, 700.0D3, 10.0D0, 20.0D0, &
      400.0D3, 10.0D0, 40.0D0, 10.0D0, 10.0D0, 10.0D0, 10.0D0, 20.0D0, 10.0D0, 200.0D6, &
      10.0D3, 10.0D3, 10.0D6, 10.0D6, 10.0D6, 10.0D6, 50.0D0, 300.0D6, &
      10.0D6, 10.0D6, 20.0D6, 200.0D6, 20.0D6, 10.0D6, &
      30.0D6, 300.0D6, 30.0D6, 10.0D6, 1.0D6, 10.0D6, 10.0D6, &
      10.0D6, 20.0D6, 10.0D6, 20.0D6, 800.0D3, 700.0D3, 10.0D6, &
      200.0D3, 500.0D3, 90.0D3, 50.0D3, 10.0D6, 100.0D6, 50.0D6, &
      500.0D6, 100.0D6, 200.0D6, 80.0D6, 30.0D6, 200.0D6, &
      100.0D6, 70.0D6/)
    step_con = 1.5D-1
