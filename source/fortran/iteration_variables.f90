...
!---------------------------------
   ...
   subroutine init_itv_174
      !! <LI> (174) fecrh_ignition (f-value for equation 85)
      use constraint_variables, only: fecrh_ignition
      use numerics, only: lablxc, boundl, boundu
      implicit none
      lablxc(174) = 'fecrh_ignition'
      boundl(174) = 0.010D0
      boundu(174) = 2.000D0
   ...
   subroutine init_itv_175
      !! <LI> (175) te0_ecrh_achievable (f-value for equation 85)
      use stellarator_variables, only: te0_ecrh_achievable
      use numerics, only: lablxc, boundl, boundu
      implicit none
      lablxc(175) = 'te0_ecrh_achievable'
      boundl(175) = 0.010D0
      boundu(175) = 200.0D0
