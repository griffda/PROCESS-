...
module numerics
  ...
  !!  <LI> (83) Radial build consistency for stellarators (itv 160 f_avspace)
  !!  <LI> (84) Lower limit for beta (itv 161 fbetatry_lower)
  !!  <LI> (85) Constraint for CP lifetime
  !!  <LI> (86) Constraint for TF coil turn dimension
  !!  <LI> (87) Checking if the design point is ECRH ignitable (itv 164 fecrh_ignition)</UL>
