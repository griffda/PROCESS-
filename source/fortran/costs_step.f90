...
contains
  ...
  subroutine step_a2201(step2298,outfile,iprint)
    ...
    ! Original STARFIRE value, scaling with fusion island volume
    step22010301 = step_ref(22) * (vfi / vfi_star)**(2.0D0/3.0D0)
    step2201 = step2201 + step22010301

    ! 22.01.03.02 PF Coils
    ! Original STARFIRE value, scaling with fusion island volume
    step22010302 = step_ref(23) * (vfi / vfi_star)**(2.0D0/3.0D0)
    ...
    ! Original STARFIRE value, scaling with fusion island volume
    step22010303 = step_ref(24) * (vfi / vfi_star)**(2.0D0/3.0D0)
    ...
    ! Original STARFIRE value, scaling with fusion island volume
    step22010304 = step_ref(25) * (vfi / vfi_star)**(2.0D0/3.0D0)
