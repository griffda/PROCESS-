! #TODO This entire module is never used and should therefore be removed. It 
! contains a call to vmcon with custom subroutine arguments (start1 and start2)
! which is no longer supported given vmcon being called from Python elsewhere.
